...
export default function ViewerLogin() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        setErrorMsg('');
        setIsLoading(true);
        console.log('Initiating Viewer Login...');
        ...
        <div className="relative h-screen flex items-center justify-center overflow-hidden bg-slate-950 text-slate-200 font-sans">
            ...
            <div className="relative z-10 w-full max-w-[420px] px-8 py-8 mx-4 mt-16 bg-[#0a0f1c]/70 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl">
                ...
                <div className="flex flex-col items-center mb-4">
                    ...
                    <h1 className="text-2xl font-extrabold text-white tracking-wide">Viewer Login</h1>
                    <p className="text-[14px] text-slate-300 mt-1">Access your viewer dashboard</p>
                ...
                <div className="mt-8 flex items-center justify-center space-x-2 opacity-50">
                    ...
                    <span className="text-[10px] text-slate-400 tracking-wide uppercase font-semibold">Secure Viewer Authentication</span>
                </div>
